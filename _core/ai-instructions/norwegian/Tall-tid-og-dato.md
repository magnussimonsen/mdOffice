...
> **Merknad om denne filen:** Dette er en opprydding av kildematerialet fra [Språkrådet – Tall, tid og dato](https://sprakradet.no/godt-og-korrekt-sprak/rettskriving-og-grammatikk/tall-tid-dato/) for bedre lesbarhet (for mennesker og AI). Endringer: overskrifter er markert med `#`/`##`, navigasjons- og skjemaelementer fra nettsiden er fjernet, og eksempler er satt i lister. Selve regelinnholdet er ikke endret.
...
Det skal **ikke** være skråstrek i datoangivelser. Ikke slik: *5/6 2026*

Den tradisjonelle rekkefølgen dag-måned-år (f.eks. 17.05.2026) er i samsvar med vanlig talemål og hvordan rekkefølgen er når man skriver månedsnavnet fullt ut: *17. mai 2026.*
...
- kl. 13 / kl. 1300 / kl. 13.00 / kl. 13:00
- kl. 9.05 / kl. 0905 / kl. 09.05 / kl. 09:05
...
Streken er en **tankestrek** (Alt + 0150 eller Windows-tasten + bindestrek), ikke en bindestrek (se [Tankestrek](Tankestrek.md)). Det skal **ikke** være mellomrom før og etter streken.
...
Med årstall: *1840–1845* eller *1840–45*. Men bare *1840–1945* (ikke forkortet når århundret endres).
...
Firesifrede tall kan også skrives sammen: *2500 biler*.
...
**Unntak:** Når tallet etter kommaet er 1, kan vi også ha entall: *0,1 milliarder* eller *0,1 milliard*.

Etter *null* skal det stå flertall: *null grader*.
...
**Unntak:** Regentnummer som skrives med romertall, skal **ikke** ha punktum:
...
**Unntak:** Telefonnummer i 8xx-serien skal skrives i tre grupper med tre + to + tre siffer: *800 22 222*.

Telefonnummer i 116-serien skal skrives i grupper på tre og tre siffer. Telefonnummer på tre, fire og fem siffer skrives i en gruppe.

## Bankkonto- og fødselsnummer

Bankkontonummer skrives i tre grupper: *2000 12 34567*.

Fødselsnummer skrives i to grupper: *180892 12345*.

## Kjapp oppsummering

| Type | Regel |
|---|---|
| Dato (allmennspråk) | dag-måned-år: 5.6.2026 — ikke skråstrek |
| Dato (teknisk) | år-måned-dag: 2026-05-17 |
| Årstall i bokstaver | Skrives i ett: nittenåttifire |
| Klokkeslett | Punktum eller kolon: kl. 13.00 / kl. 13:00 |
| Tidsrom | Tankestrek uten mellomrom: mandag–fredag |
| Små tall (t.o.m. 12) | Bokstaver, med mindre teksten er tallfokusert |
| Store tall | Gruppert i tre og tre siffer, aldri punktum: 2 500 000 |
| Omtrentlige/runde tall | Bokstaver, selv om store: en million kroner |
| Tall + forkortet målenhet | Siffer: 2 kg, 10 kr |
| Desimaltall | Komma, ikke punktum, og flertall: 1,2 grader |
| Ordenstall | Punktum: 8. mai (unntak: romertall, Olav V) |
| Telefonnummer | To og to siffer (unntak: 8xx og 116-serien) |
| Bankkontonummer | Tre grupper |
| Fødselsnummer | To grupper |
