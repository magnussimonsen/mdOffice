...
> **Merknad om denne filen:** Dette er en opprydding av kildematerialet fra [Språkrådet – Generelle skriveråd (bokmål)](https://sprakradet.no/klarsprak/om-skriving/generelle-skriverad-bokmal/) for bedre lesbarhet (for mennesker og AI). Endringer: overskrifter er markert med `#`/`##`, navigasjons- og skjemaelementer fra nettsiden er fjernet, og eksempelpar (feil/riktig) er satt i tabeller. Selve rådene er ikke endret.
...
> **Vær forsiktig med *ved* + substantiv.** I upersonlige setninger med *ved* + substantiv på -ing eller -else er det ikke alltid opplagt hvem som skal gjøre hva. Hvis du vil at mottakeren skal gjøre noe, er det bedre å bruke et konkret verb.
>
> **Eksempel 1:** Disse kan fås ved henvendelse til administrasjonen. → *Forslag til omformulering:* Disse kan du få hvis du henvender deg til administrasjonen.
>
> **Eksempel 2:** Ved innvilget avdragsordning blir nye betalingsblanketter sendt deg månedlig. → *Forslag til omformulering:* Hvis du får innvilget avdragsordning, vil du få tilsendt nye betalingsblanketter hver måned.
...
- Les korrektur. Ikke stol på stavekontrollen. Bruk ordbøker og nettstedet til Språkrådet om du er i tvil, eller be en kollega om hjelp.

## Kjapp oppsummering

| Tema | Huskeregel |
|---|---|
| Mottaker | Vit hvem du skriver for og hva de vet fra før |
| Formål | Gjør klart hvorfor mottakeren skal lese/bruke teksten |
| Struktur | Hovedoverskrift, viktigst først, avsnitt med hovedpoeng, mellomoverskrifter |
| Setninger | Korte, én ting om gangen, unngå lange innskudd og substantivsyke |
| Aktiv form | Nevn hvem som gjør hva, unngå passiv der det går |
| Ordvalg | Korte, konkrete, oppdaterte ord — unngå fyllord og gammeldagse uttrykk |
| Faguttrykk | Forklar ved første bruk, ikke med enda et faguttrykk |
| Stil og tone | Tilpass til mottaker og formål; korrekturles selv om stavekontrollen sier ja |
